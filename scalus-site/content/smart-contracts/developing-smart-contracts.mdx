---
title: Build Your First Cardano Smart Contract - Tutorial
sidebarTitle: First Smart Contract
description: Step-by-step tutorial to build, test, and debug your first Cardano validator. Learn datums, redeemers, and spending validators with working code examples.
---
...
- **[Building Transactions](/docs/transactions/building-first-transaction)** - Submit your contract to the blockchain
