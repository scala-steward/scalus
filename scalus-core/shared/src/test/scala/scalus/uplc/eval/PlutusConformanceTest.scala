...
abstract class PlutusConformanceTest extends AnyFunSuite:
    ...
    check("builtin/constant/value/duplicate-keys/duplicate-keys")
    check("builtin/constant/value/empty-tokens/empty-tokens")
    check("builtin/constant/value/empty/empty")
    check("builtin/constant/value/ill-formed/ill-formed")
    check("builtin/constant/value/key-too-long-1/key-too-long-1")
    check("builtin/constant/value/key-too-long-2/key-too-long-2")
    check("builtin/constant/value/max-key-length-1/max-key-length-1")
    check("builtin/constant/value/max-key-length-2/max-key-length-2")
    check("builtin/constant/value/multi/multi")
    check("builtin/constant/value/no-overflow/no-overflow")
    check("builtin/constant/value/no-underflow/no-underflow")
    check("builtin/constant/value/overflow/overflow")
    check("builtin/constant/value/underflow/underflow")
    check("builtin/constant/value/unordered/unordered")
    check("builtin/constant/value/zero-asset/zero-asset")
    ...
    check("builtin/semantics/insertCoin/key-too-long-1/key-too-long-1")
    check("builtin/semantics/insertCoin/key-too-long-2/key-too-long-2")
    check("builtin/semantics/insertCoin/long-key-zero-1/long-key-zero-1")
    check("builtin/semantics/insertCoin/long-key-zero-2/long-key-zero-2")
    check("builtin/semantics/insertCoin/multi-ccy-empty/multi-ccy-empty")
    check("builtin/semantics/insertCoin/multi-ccy-nonempty/multi-ccy-nonempty")
    check("builtin/semantics/insertCoin/multi-token/multi-token")
    check("builtin/semantics/insertCoin/negative-empty/negative-empty")
    check("builtin/semantics/insertCoin/no-overflow/no-overflow")
    check("builtin/semantics/insertCoin/no-underflow/no-underflow")
    check("builtin/semantics/insertCoin/overflow/overflow")
    check("builtin/semantics/insertCoin/positive-empty/positive-empty")
    check("builtin/semantics/insertCoin/positive-nonempty/positive-nonempty")
    check("builtin/semantics/insertCoin/underflow/underflow")
    check("builtin/semantics/insertCoin/zero-positive/zero-positive")
    ...
    // TODO: enable when UPLC parser supports `(con value ...)` syntax
    check("builtin/semantics/lookupCoin/absent/absent")
    check("builtin/semantics/lookupCoin/present/present")
    ...
    // TODO: enable when UPLC parser supports `(con value ...)` syntax
    check("builtin/semantics/scaleValue/by-neg/by-neg")
    check("builtin/semantics/scaleValue/by-pos/by-pos")
    check("builtin/semantics/scaleValue/by-zero/by-zero")
    check("builtin/semantics/scaleValue/no-overflow/no-overflow")
    check("builtin/semantics/scaleValue/no-underflow/no-underflow")
    check("builtin/semantics/scaleValue/overflow/overflow")
    check("builtin/semantics/scaleValue/underflow/underflow")
    ...
    // TODO: enable when UPLC parser supports `(con value ...)` syntax
    check("builtin/semantics/unionValue/cancel-01/cancel-01")
    check("builtin/semantics/unionValue/cancel-02/cancel-02")
    check("builtin/semantics/unionValue/combine/combine")
    check("builtin/semantics/unionValue/no-overflow/no-overflow")
    check("builtin/semantics/unionValue/no-underflow/no-underflow")
    check("builtin/semantics/unionValue/overflow/overflow")
    check("builtin/semantics/unionValue/underflow/underflow")
    check("builtin/semantics/unionValue/unitl/unitl")
    check("builtin/semantics/unionValue/unitr/unitr")
    // TODO: enable when UPLC parser supports `(con value ...)` syntax
    check("builtin/semantics/valueContains/ccy-missing/ccy-missing")
    check("builtin/semantics/valueContains/multi-insufficient/multi-insufficient")
    check("builtin/semantics/valueContains/multi-sufficient/multi-sufficient")
    check("builtin/semantics/valueContains/neg-empty/neg-empty")
    check("builtin/semantics/valueContains/neg-neg-eq/neg-neg-eq")
    check("builtin/semantics/valueContains/neg-neg-gt/neg-neg-gt")
    check("builtin/semantics/valueContains/neg-neg-lt/neg-neg-lt")
    check("builtin/semantics/valueContains/neg-pos/neg-pos")
    check("builtin/semantics/valueContains/pos-empty/pos-empty")
    check("builtin/semantics/valueContains/pos-neg/pos-neg")
    check("builtin/semantics/valueContains/reflexive/reflexive")
    check("builtin/semantics/valueContains/token-missing/token-missing")
