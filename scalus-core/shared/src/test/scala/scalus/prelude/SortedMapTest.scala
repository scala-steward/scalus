...
class SortedMapTest extends AnyFunSuite with EvalTestKit {
    ...
    test("Eq") {
        ...
        assertEvalWithBudget(
          SortedMap.empty[BigInt, BigInt],
          SortedMap.empty[BigInt, BigInt],
          ExUnits(5464, 1049340)
        )

        assertEvalWithBudget(
          SortedMap.singleton(BigInt(1), BigInt(1)),
          SortedMap.singleton(BigInt(1), BigInt(1)),
          ExUnits(13440, 3533864)
        )
